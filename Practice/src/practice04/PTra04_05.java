		...
		while (!winFlg /* winFlg == falseと同じ意味 */) {
			...
			if (cpuHand == 0) {
				...
				System.out.println("チョキ！！");
					...
					switch (myHand) {
						case 0: winFlg = !winFlg ;
							System.out.println("勝ち");
								break;
						case 1: System.out.println("あいこ");
							break;
							case 2: System.out.println("負け");
								break;
		   }
				...
				System.out.println("パー！！");
					...
					switch (myHand) {
						case 0: System.out.println("負け");
								break;
							case 1: winFlg = !winFlg;
								System.out.println("勝ち");
									break;
								case 2: System.out.println("あいこ");
									break;
		   }
